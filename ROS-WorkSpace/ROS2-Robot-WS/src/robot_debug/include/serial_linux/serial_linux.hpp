...
public:
    ...
    ~Serial();
    bool SerialInit();
    bool SerialWrite(short * MessageData, unsigned int MessageLenth, unsigned int MessageCode);
    bool SerialRead(short * MessageData, unsigned int * MessageLenth, unsigned int * MessageCode);
